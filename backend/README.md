...
## Project Structure
    ...
    ├── tst_sfdewbtegrv_dev_63794  # Django project configurations
...
1. Clone this repo and `cd tst_sfdewbtegrv_dev_63794`
...
2. Clone this repo and `cd tst_sfdewbtegrv_dev_63794`
